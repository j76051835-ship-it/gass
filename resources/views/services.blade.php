...
<style>
	...
	.service-period-title { display: flex; align-items: baseline; justify-content: space-between; gap: 15px; margin: 0 0 12px; color: #f7f9fc; }
	.service-period-title h3 { margin: 0; font-size: 22px; }
	.service-period-title span { color: #b9c9dc; font: 10px var(--mono); text-transform: uppercase; }
	.form-package-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 18px; margin-top: 24px; }
	.form-package-panel { min-width: 0; padding: 18px; border: 1px solid rgba(6, 27, 69, .14); border-radius: 7px; background: #fff; color: #061b45; }
	.form-package-panel h3 { margin: 0 0 5px; color: #087bdc; font-size: 20px; }
	.form-package-panel.social h3 { color: #139447; }
	.form-package-panel.carousel h3 { color: #d06a13; }
	.form-package-panel > p { margin: 0 0 14px; color: #52617b; font-size: 12px; }
	.form-package-list { display: grid; gap: 9px; margin: 0; padding: 0; list-style: none; }
	.form-package-item { display: grid; gap: 5px; padding: 12px; border-top: 1px solid #dfe7f0; }
	.form-package-item:first-child { border-top: 0; }
	.form-package-item strong { font-size: 13px; text-transform: uppercase; }
	.form-package-item span { color: #52617b; font-size: 11px; line-height: 1.45; }
	.form-package-price { color: #061b45 !important; font-weight: 700; }
	.form-package-price .price-original { margin-right: 6px; color: #8793a5; font-size: 10px; font-weight: 400; text-decoration: line-through; }
	.form-package-price .price-final { color: inherit; }
	.form-package-price .price-discount { display: inline-block; margin-left: 5px; padding: 3px 6px; border-radius: 3px; background: #e15b4f; color: #fff; font: 8px var(--mono); text-transform: uppercase; }
	.form-package-item button { justify-self: start; margin-top: 4px; padding: 9px 12px; border: 1px solid #087bdc; background: #087bdc; color: #fff; font: 600 11px var(--display); cursor: pointer; }
...
<section class="services section-shell services-page">
	...
	<div class="service-period"><div class="service-period-title"><h3>Paket Satuan</h3><span>Per item / satu kali pengerjaan</span></div><div class="form-package-grid">
		...
		<article class="form-package-panel video"><h3>C. Pembuatan Video AI</h3><p>Produksi video AI per satuan.</p><ul class="form-package-list"><li class="form-package-item"><strong>Video AI Standard</strong><span>Durasi 15 - 30 detik</span><span class="form-package-price">Rp 100.000 / satuan</span><button type="button" data-order-package="Video AI Standard" data-order-price="100000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Video AI Premium</strong><span>Durasi 15 - 60 detik</span><span class="form-package-price">Rp 175.000 / satuan</span><button type="button" data-order-package="Video AI Premium" data-order-price="175000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Video AI Professional</strong><span>Durasi 15 - 75 detik</span><span class="form-package-price">Rp 300.000 / satuan</span><button type="button" data-order-package="Video AI Professional" data-order-price="300000">Pesan Sekarang</button></li></ul></article>
		<article class="form-package-panel carousel"><h3>D. Pembuatan Carousel</h3><p>Produksi carousel per satuan.</p><ul class="form-package-list"><li class="form-package-item"><strong>Carousel Standard</strong><span>2 - 4 slide</span><span class="form-package-price">Rp 25.000 / satuan</span><button type="button" data-order-package="Carousel Standard" data-order-price="25000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Carousel Premium</strong><span>5 - 7 slide</span><span class="form-package-price">Rp 35.000 / satuan</span><button type="button" data-order-package="Carousel Premium" data-order-price="35000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Carousel Pro</strong><span>7 - 10 slide</span><span class="form-package-price">Rp 55.000 / satuan</span><button type="button" data-order-package="Carousel Pro" data-order-price="55000">Pesan Sekarang</button></li></ul></article>
	</div></div>
	<div class="service-period"><div class="service-period-title"><h3>Paket Bulanan</h3><span>Periode 30 hari</span></div><div class="form-package-grid">
		<article class="form-package-panel website"><h3>A. Website Management</h3><p>Paket maintenance website selama 30 hari.</p><ul class="form-package-list"><li class="form-package-item"><strong>Maintenance Basic</strong><span>Update teks, gambar, banner, pengecekan website, backup</span><span class="form-package-price">Rp 500.000 / bulan</span><button type="button" data-order-package="Maintenance Website Basic" data-order-price="500000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Maintenance Standard</strong><span>Semua Basic + update halaman, perbaikan minor, optimasi ringan</span><span class="form-package-price">Rp 750.000 / bulan</span><button type="button" data-order-package="Maintenance Website Standard" data-order-price="750000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Maintenance Professional</strong><span>Semua Standard + maintenance database, bug fixing, update fitur kecil</span><span class="form-package-price">Rp 1.000.000 / bulan</span><button type="button" data-order-package="Maintenance Website Professional" data-order-price="1000000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Maintenance Advanced</strong><span>Semua Professional + perbaikan bug lebih kompleks, optimasi performa, keamanan</span><span class="form-package-price">Rp 1.500.000 / bulan</span><button type="button" data-order-package="Maintenance Website Advanced" data-order-price="1500000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Maintenance Premium</strong><span>Semua Advanced + maintenance fitur kompleks, database, security, monitoring lebih intensif</span><span class="form-package-price">Rp 2.000.000 / bulan</span><button type="button" data-order-package="Maintenance Website Premium" data-order-price="2000000">Pesan Sekarang</button></li></ul></article>
		<article class="form-package-panel social"><h3>B. Social Media Management</h3><p>Pengelolaan media sosial selama 30 hari.</p><ul class="form-package-list"><li class="form-package-item"><strong>Maintenance Social Media</strong><span>Full maintenance all in / 30 hari</span><span class="form-package-price">Rp 1.000.000 / bulan</span><button type="button" data-order-package="Maintenance Social Media" data-order-price="1000000">Pesan Sekarang</button></li></ul></article>
		<article class="form-package-panel video"><h3>C. Pembuatan Video AI</h3><p>Produksi video AI sebanyak 30 item per bulan.</p><ul class="form-package-list"><li class="form-package-item"><strong>Video AI Standard Bulanan</strong><span class="form-package-price">Rp 3.000.000 / bulan</span><button type="button" data-order-package="Video AI Standard Bulanan" data-order-price="3000000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Video AI Premium Bulanan</strong><span class="form-package-price">Rp 5.250.000 / bulan</span><button type="button" data-order-package="Video AI Premium Bulanan" data-order-price="5250000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Video AI Professional Bulanan</strong><span class="form-package-price">Rp 9.000.000 / bulan</span><button type="button" data-order-package="Video AI Professional Bulanan" data-order-price="9000000">Pesan Sekarang</button></li></ul></article>
		<article class="form-package-panel carousel"><h3>D. Pembuatan Carousel</h3><p>Produksi 30 item carousel per bulan.</p><ul class="form-package-list"><li class="form-package-item"><strong>Carousel Standard Bulanan</strong><span class="form-package-price">Rp 750.000 / bulan</span><button type="button" data-order-package="Carousel Standard Bulanan" data-order-price="750000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Carousel Premium Bulanan</strong><span class="form-package-price">Rp 1.050.000 / bulan</span><button type="button" data-order-package="Carousel Premium Bulanan" data-order-price="1050000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Carousel Pro Bulanan</strong><span class="form-package-price">Rp 1.650.000 / bulan</span><button type="button" data-order-package="Carousel Pro Bulanan" data-order-price="1650000">Pesan Sekarang</button></li></ul></article>
	</div></div>
	@if (false)
	<div class="legacy-form-package-grid form-package-grid">
		<article class="form-package-panel website"><h3>A. Website Management</h3><p>Pembuatan dan pengelolaan website sesuai kebutuhan bisnis.</p><ul class="form-package-list"><li class="form-package-item"><strong>Pembuatan Website Basic</strong><span>Website basic</span><span class="form-package-price">Rp 4.000.000</span><button type="button" data-order-package="Pembuatan Website Basic" data-order-price="4000000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Pembuatan Website Standar</strong><span>Website standar</span><span class="form-package-price">Rp 5.000.000</span><button type="button" data-order-package="Pembuatan Website Standar" data-order-price="5000000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Pembuatan Website Pro</strong><span>Website profesional</span><span class="form-package-price">Rp 8.000.000</span><button type="button" data-order-package="Pembuatan Website Pro" data-order-price="8000000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Maintenance Website</strong><span>Full maintenance all in / 30 hari</span><span class="form-package-price">Rp 500.000 / bulan</span><button type="button" data-order-package="Maintenance Website" data-order-price="500000">Pesan Sekarang</button></li></ul></article>
		<article class="form-package-panel social"><h3>B. Social Media Management</h3><p>Pembuatan akun dan pengelolaan media sosial terintegrasi.</p><ul class="form-package-list"><li class="form-package-item"><strong>Pembuatan Social Media Basic</strong><span>Social media basic</span><span class="form-package-price">Rp 100.000</span><button type="button" data-order-package="Pembuatan Social Media Basic" data-order-price="100000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Pembuatan Social Media Standar</strong><span>Social media standar</span><span class="form-package-price">Rp 200.000</span><button type="button" data-order-package="Pembuatan Social Media Standar" data-order-price="200000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Pembuatan Social Media Pro</strong><span>Social media profesional</span><span class="form-package-price">Rp 300.000</span><button type="button" data-order-package="Pembuatan Social Media Pro" data-order-price="300000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Maintenance Social Media</strong><span>Full maintenance all in / 30 hari</span><span class="form-package-price">Rp 1.000.000 / bulan</span><button type="button" data-order-package="Maintenance Social Media" data-order-price="1000000">Pesan Sekarang</button></li></ul></article>
		<article class="form-package-panel video"><h3>C. Pembuatan Video AI</h3><p>Produksi video AI dengan periode satuan atau bulanan.</p><ul class="form-package-list"><li class="form-package-item"><strong>Standard</strong><span>Durasi 15 - 30 detik, konsep sederhana, script basic, visual AI 1 - 2 scene, animasi dan editing basic.</span><span class="form-package-price">Rp 100.000 / satuan · Rp 3.000.000 / bulan</span><button type="button" data-order-package="Video AI Standard" data-order-price="100000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Premium</strong><span>Durasi 15 - 60 detik, konsep kreatif marketing, karakter AI custom, animasi advance, editing professional.</span><span class="form-package-price">Rp 175.000 / satuan · Rp 5.250.000 / bulan</span><button type="button" data-order-package="Video AI Premium" data-order-price="175000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Professional</strong><span>Durasi 15 - 75 detik, konsep custom cinematic, script profesional, animasi premium, editing high end.</span><span class="form-package-price">Rp 300.000 / satuan · Rp 9.000.000 / bulan</span><button type="button" data-order-package="Video AI Professional" data-order-price="300000">Pesan Sekarang</button></li></ul></article>
		<article class="form-package-panel carousel"><h3>D. Pembuatan Carousel</h3><p>Konten carousel dengan pilihan jumlah slide dan kualitas desain.</p><ul class="form-package-list"><li class="form-package-item"><strong>Carousel Standard</strong><span>2 - 4 slide, 1080 x 1080 px / 4:5, desain basic, stock / AI.</span><span class="form-package-price">Rp 25.000 / satuan · 30 item Rp 750.000 / bulan</span><button type="button" data-order-package="Carousel Standard" data-order-price="25000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Carousel Premium</strong><span>5 - 7 slide, 1080 x 1350 px, kreatif dan profesional, marketing copy, AI custom.</span><span class="form-package-price">Rp 35.000 / satuan · 30 item Rp 1.050.000 / bulan</span><button type="button" data-order-package="Carousel Premium" data-order-price="35000">Pesan Sekarang</button></li><li class="form-package-item"><strong>Carousel Pro</strong><span>7 - 10 slide, 1080 x 1350 px, custom premium, strategi copywriting, AI custom dan high-end design.</span><span class="form-package-price">Rp 55.000 / satuan · 30 item Rp 1.650.000 / bulan</span><button type="button" data-order-package="Carousel Pro" data-order-price="55000">Pesan Sekarang</button></li></ul></article>
	</div>
	<div class="legacy-package-grid package-grid">
...
<section class="integrated-services section-shell">
	...
	@if (false)
	<section class="legacy-monthly-services monthly-services section-shell">
...
document.addEventListener('DOMContentLoaded', function () {
	...
	document.querySelectorAll('[data-order-package]').forEach(function (button) {
		...
		const formPriceElement = button.closest('.form-package-item')?.querySelector('.form-package-price');
		if (priceElement) {
		...
		if (formPriceElement) {
			const suffix = formPriceElement.textContent.includes('/ bulan') ? ' / bulan' : formPriceElement.textContent.includes('/ satuan') ? ' / satuan' : '';
			formPriceElement.innerHTML = packageData.discount > 0
				? '<span class="price-original">' + formatPrice(packageData.basePrice) + '</span><span class="price-final">' + formatPrice(packageData.price) + suffix + '</span><span class="price-discount">Diskon ' + packageData.discount + '%</span>'
				: '<span class="price-final">' + formatPrice(packageData.price) + suffix + '</span>';
		}
	});
});
</script>
